 ...
 * @see #setDataSource
 */
public class SqlSessionFactoryBean implements FactoryBean<SqlSessionFactoryBean>, InitializingBean, ApplicationListener<ApplicationEvent>{
   ...
   * {@inheritDoc}
   */
  public SqlSessionFactoryBean getObject() throws Exception {
    return this;
  }
   ...
   * {@inheritDoc}
   */
  public Class<? extends SqlSessionFactoryBean> getObjectType() {
