...
public class DataPersistenceFactory extends BaseTestCase {
	...
	private DataPersistence getDataPersistence(String id) {
		...
		while (es.hasNext()) {
			...
			Log.log("正在初始化数据:" + parameter.getTextTrim());
		}
		return dao;
	}
